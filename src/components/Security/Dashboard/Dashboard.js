...
const ResidentPortal = ({navigation}) => {
  ...
  const [isViolationModal, setViolationModal] = useState(false);
          ...
          <View style={styles.page_content}>
            ...
            <View style={styles.all_btns_view}>
              ...
              <View style={{width: '50%', padding: 5}}>
                ...
                <TouchableOpacity
                  onPress={() => navigation.navigate('SecurityCriminalTrespassList')}
                ...
                <TouchableOpacity
                  onPress={() => navigation.navigate('PoliceContactInformation')}>
                  <View style={styles.btns}>
...
const styles = StyleSheet.create({
  ...
  logo_img: {height: height / 15, width: width / 4 + 30},
  resident_portal: {
    fontSize: RFValue(27),
    fontWeight: 'bold',
    color: '#1A73E8',
